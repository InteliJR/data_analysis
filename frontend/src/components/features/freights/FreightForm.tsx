  ...
  const {
    ...
    defaultValues: freight
      ? {
          ...
          originUf: freight.originUf,
          originCity: freight.originCity,
          destinationUf: freight.destinationUf,
          destinationCity: freight.destinationCity,
          cargoType: freight.cargoType,
          operationType: freight.operationType,
          freightTaxes: freight.freightTaxes || [],
        }
      : {
          name: "",
          description: "",
      ...
      <div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div className="sm:col-span-2">
            ...
            <Input
              id="name"
              placeholder="Ex: Transporte Rodoviário SP-RJ"
              maxLength={80}
              {...register("name", {
          ...
          <div>
            ...
            <Input
              id="cargoType"
              placeholder="Ex: Carga seca, Frigorífica"
              maxLength={60}
              {...register("cargoType", {
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <div>
            ...
            >
              <option value="">Selecione</option>
              {originUfWatch &&
                cidadesPorEstado[originUfWatch]?.map((city) => (
          ...
          <div>
            ...
            >
              <option value="">Selecione</option>
              {destinationUfWatch &&
                cidadesPorEstado[destinationUfWatch]?.map((city) => (
                  <option key={city} value={city}>
                    {city}
                  </option>
                ))}
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 space-y-2">
        ...
        <div className="grid grid-cols-2 gap-2 text-sm">
          ...
          <div className="col-span-2 pt-2 border-t border-blue-300">
            <Text className="text-gray-600">Total com Impostos:</Text>
